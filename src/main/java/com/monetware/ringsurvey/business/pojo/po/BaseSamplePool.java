...
@Data
public class BaseSamplePool implements IDynamicTableName {
     ...
     * 0-未使用 1-已使用
     */
    @SQLField(column = "pool_status", type = "int")
     ...
     * 答卷变量
     */
    @SQLField(column = "response_variable", type = "text")
    private String responseVariable;

    /**
     * 附加数据
     */
    @SQLField(column = "extra_data", type = "text")
     ...
     * 最后修改用户
     */
    @SQLField(column = "last_modify_user", type = "int")
